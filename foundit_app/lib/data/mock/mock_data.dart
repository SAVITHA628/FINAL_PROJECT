...
class MockData {
  ...
  static final List<ItemModel> items = [
    ItemModel(
      ...
      description: 'Lost my blue Samsung phone near the library cafeteria. It has a transparent case with stickers on the back.',
    ...
    ItemModel(
      ...
      description: 'Found an ID card near the parking lot. Name on card: Priya Sharma, Roll: CSE-2024-042.',
      category: 'ID Card',
    ...
    ItemModel(
      ...
      description: 'A set of Maruti Suzuki car keys with a red rubber keychain. Last seen in the canteen area.',
      category: 'Keys',
    ...
    ItemModel(
      ...
      description: 'Found a black leather wallet with some cash and cards inside. Found on the football ground.',
      category: 'Wallet',
    ...
    ItemModel(
      ...
      description: 'Lost my HP laptop charger (65W, black) in Lab 204. It has a small red tape mark on the wire.',
      category: 'Electronics',
    ...
    ItemModel(
      ...
      description: 'Found a blue Wildcraft backpack near the auditorium entrance. Contains some notebooks.',
      category: 'Bag',
